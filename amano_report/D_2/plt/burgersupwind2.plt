...
do for [n=first_filenum:last_filenum]{
    ...
    imageout_name = sprintf("../imageout/burgersupwind2%06d.png", n)
    file_in_name = sprintf("../dataout/burgers_mesh100epsilon0d2%06d.dat", n)
    ...
    file_in_name using 2:4 every ::1 with lines lc rgb c4 lw 2 title 'upwind, meshnum=100' 
