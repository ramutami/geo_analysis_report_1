...
do for [n=first_filenum:last_filenum]{
    ...
    imageout_name = sprintf("../imageout/image_box_all%06d.png", n)
    file_in_name = sprintf("../dataout/box%06d.dat", n)
    ...
    file_in_name using 2:8 every ::1 with lines lc rgb c4 lw 1 title 'Kawamura-Kuwahara',\
    file_in_name using 2:7 every ::1 with lines lc rgb c6 lw 1 title 'QUICKEST'
    print n,last_filenum
}
